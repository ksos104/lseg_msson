...
CUDA_VISIBLE_DEVICES=0,1,2,3 python train_lseg_zs_proxy.py --dataset pascal --data_path /mnt/server14_hard1/msson/datasets/zs3_datasets --batch_size 2 --exp_name lseg_pascal_zs_proxy5_kl_selfN --base_lr 0.004 --weight_decay 1e-4 --no-scaleinv --max_epochs 3 --widehead --accumulate_grad_batches 2 --backbone clip_vitl16_384 --gpus 4 --no_resume --fold ${fold} --version ${fold} --use_proxy
done