...
class ViTFeat(nn.Module):
    """ Vision Transformer """
    def __init__(self, pretrained_pth, feat_dim, vit_arch = 'vit_base', vit_feat = 'k', patch_size=16):
        super().__init__()
        if vit_arch == 'vit_base' :
...
#        state_dict = torch.load(pretrained_pth, map_location="cpu")
    ...
    def forward(self, img) :
        ...
        with torch.no_grad() :
            ...
            outputs, attentions = self.model.get_last_selfattention(img)
